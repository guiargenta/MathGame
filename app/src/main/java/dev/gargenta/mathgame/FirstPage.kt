...
fun FirstPage(navController: NavController) {
    ...
    systemUIController.setSystemBarsColor(colorResource(id = R.color.green))
        ...
        content = {
            ...
            Column(
                ...
                Button(
                    ...
                    Text(
                        text = "Addition", color = Color.White, fontSize = 24.sp
                    )
                }
                ...
                Button(
                    ...
                    Text(
                        text = "Subtraction", color = Color.White, fontSize = 24.sp
                    )
                }
                ...
                Button(
                    ...
                    Text(
                        text = "Multiplication", color = Color.White, fontSize = 24.sp
                    )
                }
                ...
                Button(
                    ...
                    Text(
                        text = "Division", color = Color.White, fontSize = 24.sp
                    )
                }
